...
This notebook provides a minimal working example of the non-small cell lung cancer segmentation nnU-Net models, a series of tools for the segmentation of such masses from chest CT images. The model was trained using 420 portal venous phase CT scans. The dataset is composed of images with variable volume sizes, field of view, and image acquisition settings.
...
You can find the notebook [here](https://github.com/modelhub-ai/colab_pancreas/blob/main/nnunet_pancreas_mwe.ipynb).
